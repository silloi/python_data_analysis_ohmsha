...
estimated_y_test.to_csv('estimated_y_test.csv')  # 推定値を csv ファイルに保存。同じ名前のファイルがあるときは上書きされますので注意してください # 推定値の標準偏差を csv ファイルに保存。同じ名前のファイルがあるときは上書きされますので注意してください  # 推定値の標準偏差を csv ファイルに保存
...
std_of_estimated_y_test.to_csv('std_of_estimated_y_test.csv')  # 推定値の標準偏差を csv ファイルに保存

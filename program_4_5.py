...
r2_in_cv_all = []  # 空の list の変数を作成して、成分ごとのクロスバリデーション後の r2 をこの変数に追加
...
# %% OLS
model = LinearRegression()  # モデルおん宣言
...
standard_regression_coefficients.to_csv(
    'pcr_standard_regression_coefficients.csv')  # csv ファイルに保存
